          ...
          <Show above="sm">
            <GridItem w="100%">
              <Box>
                ...
                <Flex
                  ...
                  _hover={{ cursor: "pointer", TextDecoder: "underline" }}
                >
                  <span style={spanStyle}>About Us</span>
                  <span style={spanStyle}>Contact Us</span>{" "}
                  <span style={spanStyle}>Press Coverage</span>
                  <span style={spanStyle}>Careers</span>
                  <span style={spanStyle}>Business Partnership</span>
                  <span style={spanStyle}>Become a Health Partner</span>
                  <span style={spanStyle}>Corporate Governance</span>
                </Flex>
              </Box>
            </GridItem>
            ...
            <GridItem w="100%">
              ...
              >
                ...
                <span style={spanStyle}>Terms and Conditions</span>
                <span style={spanStyle}>Editorial Policy</span>
                <span style={spanStyle}>Return Policy</span>
                <span style={spanStyle}>IP Policy</span>
                <span style={spanStyle}>Grievance Redressal Policy</span>
              </Flex>
            </GridItem>
            ...
            <GridItem w="100%">
              ...
              <Flex
                ...
                _hover={{ cursor: "pointer", TextDecoder: "underline" }}
              >
                <span style={spanStyle}>Order Medicines</span>

                <span style={spanStyle}>Book Lab Tests</span>
                <span style={spanStyle}>Consult a Doctor</span>
                <span style={spanStyle}>Ayurveda Articles</span>
                <span style={spanStyle}>Hindi Articles</span>
                <span style={spanStyle}>Care Plan</span>
              </Flex>
            </GridItem>
